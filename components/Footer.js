...
<footer className="p-4 myfooter sm:p-6 dark:bg-gray-900">
    <div className="md:flex md:justify-center">
        <div className="mb-6 md:mb-0 mr-20">
            <a className="flex items-center">
                <img src="/logo.png" className="mr-3 h-8 w-logo" alt="Logo"/>
                <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">NFT Candy</span>
            </a>
        </div>
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-600  dark:text-white">MyPage1</h2>
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="#/" className="hover:underline">MyPage2</a>
                    </li>
                    <li>
                        <a href="#/" className="hover:underline">MyPage3</a>
                    </li>
                </ul>
            </div>
            <div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="#/" className="hover:underline">NFT</a>. All Rights Reserved.
        </span>
